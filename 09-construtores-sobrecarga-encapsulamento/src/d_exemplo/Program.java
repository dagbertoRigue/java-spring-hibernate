 ...
 * a conta. 
 * Este valor de depósito inicial, entretanto, é opcional, ou seja: se o titular não tiver 
 * dinheiro a depositar no momento de abrir sua conta, o depósito inicial não será feito e o 
 ...
 * Você deve fazer um programa que realize o cadastro de uma conta, dando opção para que 
 * seja ou não informado o valor de depósito inicial. 
 * Em seguida, realizar um depósito e depois um saque, sempre mostrando os dados da conta 
 * após cada operação.
 * */
